...
description: "Checks whether implementation or repo state has drifted away from the approved plan or canonical brief. You explicitly want implementers not to drift. Trigger when the task context clearly involves drift detection."
source: created
license: Apache-2.0
compatibility:
