---
name: error-handling
description: "Formalizes exception mapping, safe user-facing errors, redaction, and structured logging expectations. Useful for both product quality and observability. Trigger when the task context clearly involves error handling."
source: created
license: Apache-2.0
compatibility:
