...
description: "Inspects provenance, workflow state, invocation logs, and recent transitions when repo health is in question. This helps diagnose autonomous drift instead of guessing. Trigger when the task context clearly involves workflow observability."
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [observability, workflow, diagnostics]
---
