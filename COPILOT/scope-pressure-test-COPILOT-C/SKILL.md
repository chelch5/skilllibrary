...
description: "Pushes on whether the requested scope is realistic for the timeline, repo state, and available agents. A good counterweight to over-ambitious briefs. Trigger when the task context clearly involves scope pressure test."
source: created
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [scope, pressure-test, feasibility]
---
