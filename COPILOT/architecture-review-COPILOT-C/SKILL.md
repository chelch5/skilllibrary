...
description: "Evaluates whether the system shape, boundaries, dependencies, and responsibilities actually make sense. A natural fit for your multi-component systems. Trigger when the task context clearly involves architecture review."
source: created
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [architecture, review, boundaries]
---
