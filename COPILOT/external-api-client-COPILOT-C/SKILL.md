...
description: "Standardizes retries, backoff, timeout, idempotency, and SDK-versus-raw-call decisions when consuming third-party APIs. This is a recurring source of subtle bugs and cost leaks. Trigger when the task context clearly involves external api client."
source: created
license: Apache-2.0
compatibility:
