...
description: "Scans specs, tickets, decisions, and repo docs for conflicting statements or incompatible expectations. Useful because your projects often span many docs. Trigger when the task context clearly involves contradiction finder."
source: created
license: Apache-2.0
compatibility:
...
metadata:
  ...
  maturity: draft
  risk: low
  tags: [contradictions, consistency, review]
---
