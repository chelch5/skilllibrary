...
description: "Turns failures or regressions into structured root-cause, corrective-action, and prevention artifacts. Good for long-lived autonomous systems. Trigger when the task context clearly involves incident postmortem."
source: created
license: Apache-2.0
compatibility:
