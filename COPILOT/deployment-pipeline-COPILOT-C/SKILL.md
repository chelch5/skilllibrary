...
description: "Defines CI/CD, release, deployment, and rollback procedure for the chosen target. Every serious repo eventually needs this layer. Trigger when the task context clearly involves deployment pipeline."
source: created
license: Apache-2.0
compatibility:
